...
router.get("/levels/completed-all", auth_middleware_1.authenticateUser, level_controller_1.getAllCompletedLevelsByUser);
...
router.get("/levels/completed", auth_middleware_1.authenticateUser, level_controller_1.getCompletedLevelsByUser);
router.get("/levels-with-metadata/:subjectId/completed", auth_middleware_1.authenticateUser, level_controller_1.getAllCompletedLevelsByUserInSubject);
...
router.post("/levels", auth_middleware_1.authenticateUser, level_controller_1.getLevelsByIds);
