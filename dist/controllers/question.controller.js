...
const getQuestionsByLevelHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { filterByReady, page, limit, searchByTitle, filterByDifficulty, filterByQuestionType } = req.query;
        ...
        let response;
        let questions;
        let totalQuestionsCount = yield __1.prisma.question.count({ where: { levelId: level.id } });
        ...
        if (isPagination) {
            ...
            questions = yield __1.prisma.question.findMany({
        ...
        if (filterByReady !== undefined) {
            ...
            let ready = filterByReady === "true" ? true : false;
...
const deleteQuestionHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (user.role === "TEACHER") {
            const teachesGrade = yield __1.prisma.teacherGrade.findFirst({
                where: { teacherId: user.id, gradeId: question === null || question === void 0 ? void 0 : question.level.subject.gradeId },
            });
            if (!teachesGrade) {
                res.status(401).json({
                    success: false,
